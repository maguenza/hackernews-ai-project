...
class DataTransformer:
    ...
    def transform_story_data(self, story_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            """), {
                ...
                'avg_comment_length': story_data.avg_comment_length,
    ...
    def transform_user_data(self, user_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            """), {
                ...
                'avg_story_score': user_data.avg_story_score,
                'avg_comment_score': user_data.avg_comment_score,
                'engagement_score': engagement_score
            })
    ...
    def _calculate_engagement_score(self, story_data: Any) -> float:
        ...
        score = story_data.score or 0
        comments = story_data.total_comments or 0
        avg_comment_length = story_data.avg_comment_length or 0
    ...
    def _calculate_user_engagement_score(self, user_data: Any) -> float:
        ...
        # Can be enhanced with more sophisticated metrics
        stories = user_data.total_stories or 0
        comments = user_data.total_comments or 0
        avg_story_score = user_data.avg_story_score or 0
        avg_comment_score = user_data.avg_comment_score or 0
